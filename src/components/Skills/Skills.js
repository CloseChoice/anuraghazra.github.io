...
const WordClouds = () => {
  return (
    ...
    >
      ...
      <p style={{ top: 0, left: 0, fontSize: 25 }}>PySpark</p>
      <p style={{ top: 200, left: -60, fontSize: 14 }}>Pandas</p>
      <p style={{ top: '30%', left: '35%', fontSize: 18 }}>Polars</p>
      <p style={{ top: 40, left: '75%', fontSize: 12 }}>PyTorch</p>
      <p style={{ top: 380, left: '85%', fontSize: 18 }}>SQL</p>
      <p style={{ top: 320, left: '65%', fontSize: 18 }}>Machine Learning</p>
      <p style={{ top: 350, left: 150, fontSize: 20 }}>Scikit-Learn</p>
      <p style={{ top: 120, left: '22%', fontSize: 12 }}>Data Engineering</p>
    </Parallax>
  );
};
